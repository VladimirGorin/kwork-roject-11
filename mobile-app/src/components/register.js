            ...
            <ScrollView style={styles.scrollViewStyle} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.form}>
                    <View style={[styles.containerStyle, isRTL? {marginRight: 10, marginLeft: 20} : {marginLeft:0, marginRight: 20} ]}>
                        ...
                        <View style={[styles.textInputContainerStyle,{marginBottom:10,flexDirection: isRTL? 'row-reverse' : 'row', marginTop: -25}]}>
                            <Icon
                                name='mobile-phone'
                                type='font-awesome'
                                color={colors.WHITE}
                        ...
                        <View style={[styles.textInputContainerStyle,{flexDirection: isRTL? 'row-reverse' : 'row',marginTop: -20 }]}>
                            <Icon
                                name='user'
                                type='font-awesome'
                                color={colors.WHITE}
                            ...
                            />
                            <Text style={{marginLeft:20,color:colors.WHITE}}>{t('register_as_driver')}</Text>
                        </View>
