...
export default function DriverTrips(props) {
    ...
    const rCom = () => {
        return (
            <View style={{flexDirection:'row', alignItems:'center', transform: [{scaleX: isRTL==true ? -1 : 1}]}}>
                    ...
                    return (
                        <View style={styles.listItemView}>
                            ...
                            <View style={styles.mapDetails}>
                                ...
                                :null}
                                {appcat == 'delivery'?
                                <View style={[styles.textContainerStyle2, {flexDirection: isRTL? 'row-reverse' : 'row'}]}>
