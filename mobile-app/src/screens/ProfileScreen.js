...
export default function ProfileScreen(props) {
    ...
    const rCom = () =>{
        return(
            languagedata && languagedata.json? 
        ...
        <View style={styles.mainView}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={styles.scrollStyle}>
                ...
                {profileData && profileData.usertype == 'driver' ?
                    <View style={[styles.scrollViewStyle1,{flexDirection:isRTL? 'row-reverse':'row'}]}>
                ...
                <View style={styles.newViewStyle}>
                    ...
                    <View style={styles.myViewStyle}>
                        ...
                        <View style={{ flex: 1}}>
                            <Text style={styles.text2,[isRTL?{textAlign:'right',color: colors.ProfileDetails_Primary,right:10}
                            :{textAlign:'left',color: colors.ProfileDetails_Primary,left:10}]}>{profileData ? t(profileData.usertype) : ''}</Text>
                        </View>
                    </View>
                    {profileData && profileData.usertype == 'driver'?
                    <View style={styles.myViewStyle}>
                ...
                <View style={styles.flexView3}>
                 ...
                 <TouchableOpacity style={[styles.scrollViewStyle1,{flexDirection:isRTL? 'row-reverse':'row'}]} 
                   onPress={deleteAccount}>
                    ...
                    style={[styles.scrollViewStyle1,{flexDirection:isRTL? 'row-reverse':'row'}]}>
