            ...
            <ScrollView>
                ...
                <View style={styles.rideDesc}>
                    ...
                    <View style={[styles.userDesc, {flexDirection:isRTL?'row-reverse':'row'}]}>
                        ...
                        />
                        <View style={[styles.userView, isRTL?{paddingRight:28}:{paddingLeft:28}]}>
                            <Text style={[styles.textStyle,{textAlign:isRTL? "right":"left"}]}>{settings.symbol}{paramData && paramData.customer_paid ? parseFloat(paramData.customer_paid).toFixed(2) : paramData && paramData.estimate ? paramData.estimate : 0}</Text>
                        </View>
                    </View>
                </View>
                <View>
                    ...
                    <View style={styles.billView}>
                        ...
                        <View style={styles.billOptions}>
                            <View style={[styles.billItem,{flexDirection:isRTL?'row-reverse':'row'}]}>
                                ...
                                <Text style={[styles.billAmount,{textAlign:isRTL?'right':'left'}]}>{settings.symbol} {paramData && paramData.trip_cost > 0 ? parseFloat(paramData.trip_cost).toFixed(2) : paramData && paramData.estimate ? parseFloat(paramData.estimate).toFixed(2) : 0}</Text>
                            </View>
                            <View style={[styles.billItem,{flexDirection:isRTL?'row-reverse':'row'}]}>
                                <View>
                                ...
                                <Text style={[styles.discountAmount,{textAlign:isRTL?'right':'left'}]}> {isRTL? null: '-'} {settings.symbol}{paramData && paramData.discount_amount ? parseFloat(paramData.discount_amount).toFixed(2) : 0} {isRTL? '-':null}</Text>
                            ...
                            {paramData && paramData.cardPaymentAmount ? paramData.cardPaymentAmount > 0 ?
                                <View style={[styles.billItem,{flexDirection:isRTL?'row-reverse':'row'}]}>
                                    ...
                                    <Text style={{textAlign:isRTL?'right':'left'}}>  {settings.symbol}{paramData && paramData.cardPaymentAmount ? parseFloat(paramData.cardPaymentAmount).toFixed(2) : 0}</Text>
                            ...
                            {paramData && paramData.cashPaymentAmount ? paramData.cashPaymentAmount > 0 ?
                                <View style={[styles.billItem,{flexDirection:isRTL?'row-reverse':'row'}]}>
                                    ...
                                    <Text style={{textAlign:isRTL?'right':'left'}}>  {settings.symbol}{paramData && paramData.cashPaymentAmount ? parseFloat(paramData.cashPaymentAmount).toFixed(2) : 0}</Text>
                            ...
                            {paramData && paramData.usedWalletMoney ? paramData.usedWalletMoney > 0 ?
                                <View style={[styles.billItem,{flexDirection:isRTL?'row-reverse':'row'}]}>
                                    ...
                                    <Text style={{textAlign:isRTL?'right':'left'}}>  {settings.symbol}{paramData && paramData.usedWalletMoney ? parseFloat(paramData.usedWalletMoney).toFixed(2) : 0}</Text>
                        ...
                        <View style={[styles.paybleAmtView,{flexDirection:isRTL?'row-reverse':'row'}]}>
                            ...
                            <Text style={[styles.billAmount2,{textAlign:isRTL?'right':'left'}]}>{settings.symbol}{paramData && paramData.customer_paid ? parseFloat(paramData.customer_paid).toFixed(2) : null}</Text>
                        </View>
                    </View>
                    : null}
                {paramData &&  ['PENDING','PAID','COMPLETE'].indexOf(paramData.status) != -1 ?
